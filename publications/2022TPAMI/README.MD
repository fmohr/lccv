...
To replicate a specific experiment, you can proceed as follows using *the same environment installed with the code above and departing from the TPAMI2022 folder* (tested only under Linux with Python 3.9):
```bash
